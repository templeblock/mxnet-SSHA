...
def get_ssh_conv(data):
    ...
    m1 = ssh_detection_module(relu4_3, 256, 'ssh_m1_det')

    pool4 = mx.symbol.Pooling(
        data=m1, pool_type="max", kernel=(2, 2), stride=(2, 2), name="pool4")
    # group 5
    ...
    m2 = ssh_detection_module(relu5_3, 256, 'ssh_m2_det')

    m3_pool = mx.sym.Pooling(data=m2, kernel=(2, 2), stride=(2,2), pad=(0,0), pool_type='max')
    m3 = ssh_detection_module(m3_pool, 256, 'ssh_m3_det')
